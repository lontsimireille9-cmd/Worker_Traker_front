...
export function EmployeeTaskChart({ daily, employees }) {
  ...
  return <>
    <Button type="Button" onClick={() => setExpanded(true)} className="group relative block w-full cursor-zoom-in text-left" aria-label="Ouvrir le graphique détaillé">{chart}<span className="pointer-events-none absolute right-2 top-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white/90 text-[#1769E8] opacity-70 shadow-sm group-hover:opacity-100"><FaExpand size={13} /></span></Button>
