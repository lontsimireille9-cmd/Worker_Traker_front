...
export default function Profile() {
  ...
  useEffect(() => {
    api.get("/companies/current").then((data) => { setCompany(data); setForm({ name: data.name || "", address: data.address || "", phone: data.phone || "", email: data.email || "" }); }).catch((err) => setError(err.message));
  }, [activeCompany?.id]);
