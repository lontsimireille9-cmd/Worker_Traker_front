...
export default function Employees() {
  ...
  return (
    <div>
      ...
      <Card className="mb-8">
        <form onSubmit={handleCreate} className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-8">
      ...
      <div className="space-y-2">
        {employees.map((emp) => (
          <Card key={emp.uid} className="flex min-w-0 flex-wrap items-center justify-between gap-3">
            <div>
